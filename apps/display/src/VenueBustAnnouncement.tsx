...
export default function VenueBustAnnouncement({ busts }: VenueBustAnnouncementProps) {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="relative w-full max-w-[min(52rem,96vw)] rounded-2xl border border-red-500/45 bg-gradient-to-b from-[#1a0508] via-[#12040a] to-black/90 px-6 py-7 shadow-[0_0_48px_rgba(239,68,68,0.22)] sm:px-10 sm:py-9"
      ...
      >
        <div className="mb-5 flex items-center justify-between gap-4 border-b border-red-500/25 pb-4">
